...
<body>
    ...
    <section id="sideber" class="sideber">
        <ul class="sideber__ber">
            <h3 class="sideber__panel"><i id="left" class="fas fa-laugh-wink"></i> Doccur</h3>
    ...
    echo " active";
        ...
        <footer class="text-center"><span>Doccur</span><br>©2020 Doccur All right reserved.</footer>
    </section>
    <!--------------------------------- #Sideber -------------------------------->
